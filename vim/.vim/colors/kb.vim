...
if &background == "dark"
    ...
    if s:kb_monochrome == 1
        ...
        hi StatusLine ctermbg=LightGray ctermfg=DarkBlue guibg=#334b7d guifg=fg gui=bold
        hi StatusLineNC ctermbg=DarkGray ctermfg=DarkBlue guibg=#25365a guifg=fg gui=none
